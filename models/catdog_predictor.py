...
LOGGER.log.info("Starting Model Servering")


# initialize model with pretrained weight and do inference
class Predictor:
    ...
    async def predict(self, image):
        ...
        img_tensor = self.transforms_(pil_img)
        transformed_image = img_tensor.unsqueeze(0)
    ...
    def output2pred(self, output):
        ...
        predicted_id = int(torch.max(probabilities, 1)[1].item())
